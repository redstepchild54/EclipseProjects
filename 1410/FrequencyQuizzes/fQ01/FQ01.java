...
/********************************************************************* 
 * SuperFast*
 * You are given 2  integer values: the average speed 
 * and the maximum speed of a vehicle.
 * The question is: is the vehicle super fast?
 * 
 * Return true if at least one of the following is true:
 * avgSpeed is greater 100 mph or maxSpeed is greater 150 mph.
 * Except if it is a plane. If the parameter "isPlane" is true,
 * both the avgSpeed and the maxSpeed need to be greater 300
 * in order to return true (to be considered super fast).
 * 
 * E.g.
 * superFast(94, 150, false) -> false
 * superFast(101, 140, false) -> true
 * superFast(83, 162, false) -> true
 * superFast(111, 162, false) -> true
 * superFast(111, 301, true) -> false
 * superFast(301, 320, true) -> true
 ***********************************************************************/
